    ...
    <div class="bg-white rounded-2xl border border-violet-100 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('addMembre', $colocation->id) }}" method="POST"
            ...
            <input type="email" name="email" required
                   ...
                   class="flex-1 px-4 py-2.5 rounded-xl border border-violet-200 bg-violet-50/50
    ...
    <div class="bg-white rounded-2xl border border-violet-100 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-4 px-6 py-4 border-b border-slate-50 last:border-0
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-0.5 flex-wrap">
                        ...
                        {{-- Statut banni --}}
                        @if($user->is_banned)
                            <span class="text-xs font-medium text-rose-600 bg-rose-50 border border-rose-100
                                         px-2 py-0.5 rounded-full">
                                Banni
                            </span>
                        @else
                            <span class="text-xs font-medium text-emerald-600 bg-emerald-50 border border-emerald-100
                                         px-2 py-0.5 rounded-full">
                                Actif
                            </span>
                        @endif
                ...
                <form action="" method="POST" class="flex-shrink-0">
                    ...
                    <button type="submit"
                            ...
                            class="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-rose-200
        ...
        @empty
            <div class="px-6 py-10 text-center">
                ...
                <p class="text-slate-300 text-xs mt-1">Invitez votre premier colocataire ci-dessus.</p>
            </div>
        @endforelse
    </div>
